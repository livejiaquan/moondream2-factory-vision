#!/usr/bin/env python3
"""
Factory safety feasibility test — 針對 data/raw_videos/ 影片做安全檢測測試。
輸出至 experiments/01_basic_factory_feasibility/outputs/feasibility/<timestamp>/
"""
...
OUTPUT_ROOT = EXPERIMENT_DIR / "outputs" / "feasibility"
