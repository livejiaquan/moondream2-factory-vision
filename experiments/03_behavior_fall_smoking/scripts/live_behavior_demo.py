...
Usage:
    python experiments/03_behavior_fall_smoking/scripts/live_behavior_demo.py                              # file picker (multi-select)
    python experiments/03_behavior_fall_smoking/scripts/live_behavior_demo.py --video A.mp4 B.mp4          # explicit order, loops at end
    python experiments/03_behavior_fall_smoking/scripts/live_behavior_demo.py --folder data/behavior_videos  # whole folder, name-sorted
    python experiments/03_behavior_fall_smoking/scripts/live_behavior_demo.py --folder ... --speed 0.5     # slow short clips down
    python experiments/03_behavior_fall_smoking/scripts/live_behavior_demo.py --folder ... --max-width 512 # ~3x faster inference on MPS
    python experiments/03_behavior_fall_smoking/scripts/live_behavior_demo.py --selftest --folder ...      # render layout preview PNGs
...
def run_selftest(args) -> int:
    ...
    info = {
        "video_name": "fall_01.mp4", "video_time": 4.5, "video_dur": 6.0,
