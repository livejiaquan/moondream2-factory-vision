...
DEFAULT_DATA = PROJECT_ROOT / "data" / "raw_videos"
    ...
    *,
    ...
    parts.append(
        _occlusion_experiment_section(
            ...
            entries,
            occlusion_jsonl,
            data_dir or DEFAULT_DATA,
        )
    )
    parts.append(_conclusion(config, with_p))
    parts.append(_pipeline_section())
    parts.append(_phase2_occlusion_section(run_dir, data_dir or DEFAULT_DATA))
    parts.append(_helmet_consistency_section(run_dir, data_dir or DEFAULT_DATA))
    parts.append(_mask_occlusion_section(run_dir, data_dir or DEFAULT_DATA))
...
<pre style="background:#f1f5f9;padding:12px;border-radius:8px;font-size:13px;">cd experiments/02_yolo_gap_negative_baseline
